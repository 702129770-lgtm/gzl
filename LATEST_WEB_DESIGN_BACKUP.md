...
| 制作规范 | `PPT_Canva_Workflow_Operation_Doc.md` | Canva 优先 PPT 制作工作流和人工执行规则 |
...
| `style` | 选择风格 | 提供 3 个推荐风格和 1 个自定义风格 |
| `sample` | 确认样稿 | 展示样稿方向、页面结构和确认后的动作 |
...
当前设计参考已经收敛为 4 个可选方向，统一写在 `js/main.js` 的 `styles` 数组中。

| 风格 ID | 风格名称 | 适用场景 | 设计取向 |
| --- | --- | --- | --- |
| `profile` | 高可信人物风 | CEO 介绍、个人品牌、公司简介 | 深色标题、清晰履历卡片、稳重可信 |
| `product` | 科技产品风 | 产品介绍、项目汇报、客户提案 | 信息卡片、模块化结构、数据表达清晰 |
| `pitch` | 高冲击路演风 | 融资路演、增长汇报、商业计划 | 关键数字突出、页面节奏更强 |
...
- 旧的制作流程说明没有并入网页代码，保留为规范文档：`PPT_Canva_Workflow_Operation_Doc.md`。
